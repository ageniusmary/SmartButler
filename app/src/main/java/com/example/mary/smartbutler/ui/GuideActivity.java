...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setPoint(boolean isCheck1,boolean isCheck2,boolean isCheck3){
        if(isCheck1){
            point1.setBackgroundResource(R.drawable.cricle);
        }else {
            point1.setBackgroundResource(R.drawable.cricle1);
        }
        if(isCheck2){
            point2.setBackgroundResource(R.drawable.cricle);
        }else {
            point2.setBackgroundResource(R.drawable.cricle1);
        }
        if(isCheck3){
            point3.setBackgroundResource(R.drawable.cricle);
        }else {
            point3.setBackgroundResource(R.drawable.cricle1);
        }
    }
}
