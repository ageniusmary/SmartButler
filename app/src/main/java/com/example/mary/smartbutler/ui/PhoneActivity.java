...
public class PhoneActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void parsingJson(String t) {
        try {
            ...
            switch (company){
                case "移动":
                    iv_company.setBackgroundResource(R.drawable.chinamobile);
                    break;
                case "联通":
                    iv_company.setBackgroundResource(R.drawable.chinaunicom);
                    break;
                case "电信":
                    iv_company.setBackgroundResource(R.drawable.chinatelecom);
                    break;
            }
